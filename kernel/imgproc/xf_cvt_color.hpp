...
// clang-format on
    ...
    xfrgb2uyvy<SRC_T, DST_T, ROWS, COLS, NPC, XF_WORDWIDTH(SRC_T, NPC), XF_WORDWIDTH(DST_T, NPC),
               (ROWS * (COLS >> (XF_NPIXPERCYCLE(NPC)))), ((1 << XF_BITSHIFT(NPC)) >> 1)>(_src, _dst, _src.rows, _src.cols);
}
//////////////////////////////////////////////////////end of
/// RGB2UYVY//////////////////////////////////////////////////////////////
...
// clang-format on
    ...
    xfrgb2bgr<SRC_T, DST_T, ROWS, COLS, NPC, XF_WORDWIDTH(SRC_T, NPC), XF_WORDWIDTH(DST_T, NPC),
              ((COLS >> (XF_NPIXPERCYCLE(NPC)))), ((1 << XF_BITSHIFT(NPC)) >> 1)>(_src, _dst, _src.rows, _src.cols);
}
//////////////////////////////////////////////////////end of
/// RGB2BGR//////////////////////////////////////////////////////////////
