...
//       xf::cv::bgr2rgb<XF_8UC3,XF_8UC3, HEIGHT, WIDTH, NPC1>(imgInput0, imgOutput0);
	...
	xf::cv::letterbox<INTERPOLATION,TYPE,HEIGHT,WIDTH,NEWHEIGHT,NEWWIDTH,NPC_T,MAXDOWNSCALE,128> (imgInput0, out_mat, rows_out_resize, cols_out_resize);
...
//void xf_pp_resize(ap_uint<INPUT_PTR_WIDTH>* img_inp,
//                       ap_uint<OUTPUT_PTR_WIDTH>* img_out,
//                       int rows_in,
//                       int cols_in,
//                       int rows_out,
...
////       xf::cv::bgr2rgb<XF_8UC3,XF_8UC3, HEIGHT, WIDTH, NPC1>(imgInput0, imgOutput0);
//
////	xf::cv::resize<INTERPOLATION,TYPE,HEIGHT,WIDTH,NEWHEIGHT,NEWWIDTH,NPC_T,MAXDOWNSCALE,128> (imgInput0, out_mat, rows_out_resize, cols_out_resize);
